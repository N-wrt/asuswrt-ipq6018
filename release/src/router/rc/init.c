...
//		nvram_set_int("led_all_gpio", 10|GPIO_ACTIVE_LOW);
	...
	case MODEL_PLAX56XP4:
		...
		nvram_set_int("led_blue_gpio", 37|GPIO_ACTIVE_LOW);
		nvram_set_int("led_green_gpio", 50);
		nvram_set_int("led_red_gpio", 35|GPIO_ACTIVE_LOW);
		nvram_set_int("btn_rst_gpio_1", 9|GPIO_ACTIVE_LOW);
		nvram_set_int("btn_wps_gpio_1", 8|GPIO_ACTIVE_LOW);
		...
		nvram_set("amas_lldp_iftypes", "4 4 4"); /* PLC, 1G, 1G */
#endif
		} // XP4
		break;
#endif	/* PLAX56_XP4 */
